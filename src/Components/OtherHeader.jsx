...
const OtherHeader = ({ backgroundImage, title, subTitle }) => {
    return (
        <header
            ...
            <div className="absolute inset-0 bg-secondary bg-opacity-70 flex flex-col gap-3 items-center justify-center text-center p-6">
                <h2 className="font-workSans text-white font-medium text-3xl md:text-4xl">{title}</h2>
