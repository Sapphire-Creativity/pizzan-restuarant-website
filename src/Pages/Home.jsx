...
const Home = () => {
    return (
        <>
            ...
            {/* Slide Menu */}
            <section className='py-20 px-16 md:px-20 mx-auto'>
                ...
                >
                    {SlideFoodMenu.map((data) => (
                        <SwiperSlide key={data.id}>
                            <div className='py-10 rounded-lg bg-accent text-center flex flex-col items-center justify-center cursor-pointer'>
